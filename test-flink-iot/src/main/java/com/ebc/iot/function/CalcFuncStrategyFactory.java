...
import com.ebc.iot.function.strategy.CalcDailyStatsFunc;
...
import com.ebc.iot.function.strategy.diff.HourDiffCalcFunc;
...
public class CalcFuncStrategyFactory implements Serializable {
    ...
    public void init(RuntimeContext ctx) {
        ...
        strategies.put("HOUR_DIFF", new HourDiffCalcFunc());
        ...
        strategies.put("DAILY_STATS", new CalcDailyStatsFunc());
